...
<div class="container">
  ...
  <div v-if="activeButton === 1" class="text-post">
    ...
    <p>Call Mr. Dominic Ling (BSW2282) , For more information.</p>
  ...
  <div v-if="activeButton === 2">
    ...
    <p>walking distance to Sarawak General Hospital</p>
    <br>
    <p>>> Renting Price: <b>RM 1 600</b> / month</p>
    <p>>> Block B, Level 3A</p>
    <br>
    <p>Disclaimer: Please obtain details from our sales person. </p>
    <p>Information in ad may not be fully descriptive.</p>
    ...
    <table>
      <thead>
        ...
        <tr>
          <td style="width: 40%">Rental Period</td>
          <td style="width: 60%">6 to 12 Months</td>
        </tr>
        <tr>
          <td >Level</td>
          <td >3A</td>
  ...
  <div v-if="activeButton === 3">
    ...
    <table>
      <thead>
        ...
        <tr>
          <td style="width: 40%">Rental Period</td>
          <td style="width: 60%"> 1 Year & Above</td>
        </tr>
        <tr>
          <td >Level</td>
          <td >3A</td>
