<template>
    ...
    <div class="container">
      ...
      <div v-if="activeButton === 1" class="text-post">
        ...
        <p>Call Eric Bong , For more information.</p>
        <p>Whatapps: 011 3336 8834</p>
        <p>Referral fee: 8%</p>
        <br>
        <p>SOHO Apartment For RENT!! </p>
        <br>
        <p>📌 Location: Kozi Square</p>
        <p>walking distance to Sarawak General Hospital</p>
        <br>
        <p>Immediate Availability</p>
        <p>>> Renting Price: <b>RM 1 000</b> / month</p>
        <p>>> 2 units:</p>
        <p>1 unit with Queen size bed</p>
        <p>1 unit with 2 single beds.</p>
        <p>>> 1 year term</p>
        <br>
