<template>
    ...
    <div class="container">
      ...
      <div v-if="activeButton === 1" class="text-post">
        ...
        <p>Call Sheena Poh , For more information.</p>
        <p>Whatapps: 019-2187896</p>
        <br>
        <p>LD Legenda Soho Suites For Rent </p>
        <br>
        <p>Located above Kozi Square</p>
        <p>walking distance to Sarawak General Hospital</p>
        <br>
        <p>Available: 15th August 2023</p>
